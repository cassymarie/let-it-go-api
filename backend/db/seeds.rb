...
Expression.create(description: 'angry', imageUrl: 'angry.png')
Expression.create(description: 'confused', imageUrl: 'confused.png')
Expression.create(description: 'cry1', imageUrl: 'cry1.png')
Expression.create(description: 'cry2', imageUrl: 'cry2.png')
Expression.create(description: 'gasp', imageUrl: 'gasp.png')
Expression.create(description: 'happy_tongue', imageUrl: 'happy_tongue.png')
Expression.create(description: 'happy', imageUrl: 'happy.png')
Expression.create(description: 'mad', imageUrl: 'mad.png')
Expression.create(description: 'nervous', imageUrl: 'nervous.png')
Expression.create(description: 'rage', imageUrl: 'rage.png')
Expression.create(description: 'scared_angry', imageUrl: 'scared_angry.png')
Expression.create(description: 'scream_big', imageUrl: 'scream_big.png')
Expression.create(description: 'scream', imageUrl: 'scream.png')
Expression.create(description: 'surprised', imageUrl: 'surprised.png')
Expression.create(description: 'tired', imageUrl: 'tired.png')
Expression.create(description: 'wink', imageUrl: 'wink.png')
Expression.create(description: 'winse', imageUrl: 'winse.png')
Expression.create(description: 'worried', imageUrl: 'worried.png')


Item.create(name: 'pie', damage: 5, base_imageUrl: "pie.png", splat_imageUrl: "pie_splat.png")
Item.create(name: 'ball', damage: 2, base_imageUrl: "ball.png", splat_imageUrl: "ball_splat.png")
Item.create(name: 'shoe', damage: 3, base_imageUrl: "shoe.png", splat_imageUrl: "shoe_print.png")
Item.create(name: 'tomato', damage: 3, base_imageUrl: "tomato.png", splat_imageUrl: "tomato_splat.png")
Item.create(name: 'bottle', damage: 5, base_imageUrl: "bottle.png", splat_imageUrl: "bottle_explode.png")
Item.create(name: 'bomb', damage: 5, base_imageUrl: "bomb.png", splat_imageUrl: "bomb_explode.png")
Item.create(name: 'watermelon', damage: 5, base_imageUrl: "watermelon.png", splat_imageUrl: "watermelon_splash.png")